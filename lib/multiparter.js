...
(function(exports) {
    ...
    request.prototype.setParam = function(name, value) {
        var sizeSum = Buffer.byteLength(name) + Buffer.byteLength(value);

        this.params[name] = value;

        this.addParamLength(sizeSum);
    };

    request.prototype.addParamLength = function(sizeSumnameSize, valueSize) {
    ...
    request.prototype.addStream = function(name, file, type, size, stream) {
        var sizeSum = Buffer.byteLength(name) + Buffer.byteLength(file) +
                      size + type.length;
